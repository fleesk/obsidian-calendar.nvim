...
A neovim plugin that adds a simple calendar window which can be used to open daily notes with [obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim).
